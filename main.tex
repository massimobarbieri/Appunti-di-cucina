...
%\input{./ricette/tataki-di-tonno-agli-agrumi.tex}
%
\newpage
\part{Secondi di carne}
\input{./Ricette/Secondi-di-carne/nuggets-di-pollo}
\input{./Ricette/Secondi-di-carne/polpettone.tex}
%
%\newpage
%\part{BBQ}
%\input{./ricette/eliche-di-pollo-al-curry.tex}
%\input{./ricette/smoked-chicken-wings.tex}
%\input{./ricette/bombette-pugliesi.tex}
%\input{./ricette/involtini-alla-siciliana.tex}
%
%\newpage
