...
%\freeze
\begin{ingreds}
	200g mandorle tritate (o farina di mandorle) \index{farina di mandorle}
	200g zucchero \index{zucchero}
	3 uova \index{uova}
	pasta frolla (realizzata con un uovo)
	buccia di 2 limone
	marmellata \index{marmellata}
	cacao amaro \index{cacao}
	un bicchiere di sassolino \index{sassolino}
