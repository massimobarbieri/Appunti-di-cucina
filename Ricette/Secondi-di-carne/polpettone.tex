...
\autore{Max}
\begin{ingreds}
	600g macinato di manzo + una salsiccia di maiale  \index{macinato}\index{salsiccia}
	pecorino grattugiato \index{pecorino}
	Parmigiano Reggiano grattugiato \index{Parmigiano Reggiano}
	pane ammollato nel latte \index{latte}
	2 uova \index{uova}
	sale
	pepe
	prezzemolo, timo o altre erbe aromatiche
	prosciutto cotto\index{prosciutto cotto}
	provola o scamorza \index{provola}
