...
\mainmatter
\part{Introduzione}
\input{ricette/temperature-di-cottura.tex}
...
\newpage
\part{Pesce}
\input{./ricette/risotto-alla-gallinella.tex}
\input{./ricette/pesce-spada-al-salmoriglio.tex}
...
\input{./ricette/biscotti-di-natale.tex}
